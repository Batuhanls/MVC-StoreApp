    ...
    public class ProductConfig : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.HasData(
                ...
                new Product() { ProductId = 8, CategoryId=2, ImageUrl="/images/4.jpg", ProductName = "Galaxy FE", Price = 7_000 ,ShowCase=true},
                new Product() { ProductId = 9, CategoryId=2, ImageUrl="/images/5.jpg", ProductName = "YSDA", Price = 1_500,ShowCase=true },
                new Product() { ProductId = 10, CategoryId=1, ImageUrl="/images/6.jpg", ProductName = "HP MOSUE", Price = 25 ,ShowCase=true}
            );
        }
    }
}